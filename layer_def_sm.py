...
def res_block(x, a=None, filter_size=16, nonlinearity=concat_elu, keep_p=1.0, stride=1, gated=True, name="resnet", begin_nonlinearity=True,begin_batch_normalize=True):
    

  #with tf.variable_scope(name) as scope:
  orig_x = x
  # if begin_batch_normalize:
  #   input_channels = x.get_shape()[-1]
  #   x = batch_normalization_layer(x, input_channels)
